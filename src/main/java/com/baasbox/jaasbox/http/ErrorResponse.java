package com.baasbox.jaasbox.http;
...
public class ErrorResponse {
     ...
     */
  public static ErrorResponse fromJson(String json) throws BBException {
      ...
      throw new BBException("Failed to convert json to an error response", e);
        } catch(JsonParseException e) {
      throw new BBException("Json is not valid format", e);
        } catch(IOException e) {
      throw new BBException("Unexpected exception when parsing json", e);
        }
    }
